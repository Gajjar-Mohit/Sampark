...
console.log("=== Transaction ID Generation Examples ===");
console.log("PVB (Paisa Vasool Bank):", generateTransactionId("PVB"));
console.log("BRG (Babu Rao Ganpatrao Bank):", generateTransactionId("BRG"));
console.log("CMK (Chinta Mat Karo Bank):", generateTransactionId("CMK"));
console.log("CPB (Chai Pani Bank):", generateTransactionId("CPB"));

console.log("\n=== Decoding Examples ===");
const sampleId = generateTransactionId("PVB");
console.log("Generated ID:", sampleId);
const decoded = decodeTransactionId(sampleId);
console.log("Decoded:", decoded.details);

// Test with different banks
const brg = generateTransactionId("BRG");
const cmk = generateTransactionId("CMK");
console.log("\nBRG ID:", brg);
console.log("BRG Decoded:", decodeTransactionId(brg).details);
console.log("\nCMK ID:", cmk);
console.log("CMK Decoded:", decodeTransactionId(cmk).details);
